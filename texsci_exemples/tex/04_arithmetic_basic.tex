...
\begin{texsci}{main}
\Constant{$a = 42 \in \Integer, u = \true \in \Boolean, lo = 5.5 \in \Real$}
\Input{$k \in \Integer, z \in \Real, y \in \Boolean$}
\Output{$res \in \Integer$}
\Local{$b \in \Integer, c \in \Real, d \in \Boolean$}
\BlankLine
$a \leftarrow 30$\;
$b \leftarrow 10$\;
$c \leftarrow a + b$\;
